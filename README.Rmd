...
This package is a fork of Bioconductor R package ['copynumber'](https://bioconductor.org/packages/release/bioc/html/copynumber.html) with minor modification for supporting hg38 genome
assembly. The idea from https://github.com/aroneklund/copynumber is adopted to generate 'hg38' object, the process
is recorded in `data-raw/`.
